...
export function ConsentGate({
  ...
  return (
    ...
    >
      ...
      />
      <p className="relative font-display text-base font-bold text-cream">{t("externalContent", { provider })}</p>
      ...
      <div className="relative mt-5 flex flex-wrap items-center justify-center gap-2">
        <button type="button" onClick={() => grantCategory(category)} className="btn btn-diamond btn-md">
          ...
          {buttonLabel ?? t("loadProvider", { provider })}
        </button>
      ...
      >
        {privacyLabel ?? t("privacyPolicyOf", { provider })}
